...
# 	@load "/slimdata/rafaeldata/brain_cond_data/brain_full_water_no_rho_no_isic_grad_iter_3_ind_"*string(i)*".jld2" Y_train m0  

# 	grad_train[:,:,:, i] = mean(Y_train;dims=3)
# 	m0_train[:,:,:, i] = m0'
# end

# @save "/slimdata/rafaeldata/brain_cond_data/grad_water_no_rho_no_isic_iter_3.jld2" grad_train m0_train 
...
# Plotting configs
sim_name = "cond-net-norho-iter-3"
...
m0_train = JLD2.jldopen("/slimdata/rafaeldata/brain_cond_data/grad_water_no_rho_no_isic_iter_3.jld2", "r")["m0_train"];
#m0_train = permutedims(m0_train,(2,1,3,4))
grad_train = JLD2.jldopen("/slimdata/rafaeldata/brain_cond_data/grad_water_no_rho_no_isic_iter_3.jld2", "r")["grad_train"];
